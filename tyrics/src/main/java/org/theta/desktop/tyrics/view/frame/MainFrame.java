 ...
 */
public class MainFrame extends Frame implements MouseMotionListener, MouseListener, PollConsumer {
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        this.setLocation(location.x + (e.getX() - firstPoint.x), location.y + (e.getY() - firstPoint.y));
    }
